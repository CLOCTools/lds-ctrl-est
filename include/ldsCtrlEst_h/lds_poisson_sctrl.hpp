#ifndef LDS_POISSON_SWITCHED_CTRL_HPP
#define LDS_POISSON_SWITCHED_CTRL_HPP
...
namespace lds {
	namespace poisson {
		...
		public:
			sctrl_t(std::size_t nSys, std::size_t nU, std::size_t nX, std::size_t nY, data_t& uLB, data_t& uUB, data_t& dt, data_t& p0=DEFAULT_P0, data_t& q0=DEFAULT_Q0, size_t controlType=0);
			...
			// Would be faster to toggle between ctrl_t's and replace wrapper u, x, P, m, P_m
			// however, I would have to override most functionality.
