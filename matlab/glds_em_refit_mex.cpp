...
class MexFunction : public matlab::mex::Function {
 ...
 public:
  ...
  void operator()(ArgumentList outputs, ArgumentList inputs) {
    ...
    lds::Matrix r_0 =
        armamexcpp::m2a_mat<data_t>(matlab_ptr_->getProperty(fit0, u"R"));

    lds::gaussian::Fit lds_fit(b_0.n_cols, a_0.n_rows, c_0.n_rows, dt);
    lds_fit.set_A(a_0);
    lds_fit.set_B(b_0);
    lds_fit.set_g(g_0);
    lds_fit.set_m(m_0);
