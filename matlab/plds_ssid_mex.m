...
%
% Fit dynamics of a Poisson Linear Dynamical System (PLDS) by subspace identification, using a Poisson->Gaussian moment conversion method of Buesing et al. 2012 ("Spectral learning of linear dynamics from generalised-linear observations with application to neural population data").
%
% INPUTS
...
% 2021/03 : mfbolus (removed unused options and edited to use Buesing method)
