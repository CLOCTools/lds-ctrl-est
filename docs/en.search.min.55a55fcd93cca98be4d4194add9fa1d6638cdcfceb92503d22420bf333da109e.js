...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/ldsctrlest/flexsearch.min.js');loadScript('/ldsctrlest/en.search-data.min.ed6778116664f9b3b3bf21fda49088bc814ffbc43ccf99934d1dbb594db2ddce.js',function(){input.required=false;search();});}
