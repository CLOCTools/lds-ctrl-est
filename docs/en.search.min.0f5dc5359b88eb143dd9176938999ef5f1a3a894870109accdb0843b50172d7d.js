...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/ldsctrlest/flexsearch.min.js');loadScript('/ldsctrlest/en.search-data.min.777c2179df0d934e2a44e10c1028e7cd8e54d1be96cb65f3c92d7a5602e45583.js',function(){input.required=false;search();});}
