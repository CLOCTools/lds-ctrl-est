...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/ldsctrlest/flexsearch.min.js');loadScript('/ldsctrlest/en.search-data.min.6be4de30bc7add12da197665f03277241a77ce495f662a41792f935e63dae5a7.js',function(){input.required=false;search();});}
