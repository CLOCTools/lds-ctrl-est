...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/ldsCtrlEst/flexsearch.min.js');loadScript('/ldsCtrlEst/en.search-data.min.4b046fbd84e14b31bd451d326660e3a7fad34d68d17e88a86cb51fedc5b90687.js',function(){input.required=false;search();});}
