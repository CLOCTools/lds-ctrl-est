...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/lds-ctrl-est/flexsearch.min.js');loadScript('/lds-ctrl-est/en.search-data.min.45147db5ec17db89947ba5299d11633774588a8f23c026aae194bc1934f0f974.js',function(){input.required=false;search();});}
