...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/lds-ctrl-est/flexsearch.min.js');loadScript('/lds-ctrl-est/en.search-data.min.133c5e9a8eaed3697b4129bf59d18d44003c6594843fae57f113022bd378ec00.js',function(){input.required=false;search();});}
