...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/lds-ctrl-est/flexsearch.min.js');loadScript('/lds-ctrl-est/en.search-data.min.9767152abebbe407f97fdb00df21aba467b66b9a57798d21a154093aac3586f1.js',function(){input.required=false;search();});}
