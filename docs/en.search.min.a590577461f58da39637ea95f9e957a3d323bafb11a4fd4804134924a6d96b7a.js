...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/ldsctrlest/flexsearch.min.js');loadScript('/ldsctrlest/en.search-data.min.0cc85c153702c6e9daff9af06fc4c3481443630788a406665cd4bf324c05f871.js',function(){input.required=false;search();});}
