...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/lds-ctrl-est/flexsearch.min.js');loadScript('/lds-ctrl-est/en.search-data.min.0c356c5434ef9c2fde946515a99d13ea7e2def0a20a0d701a0ca3cfb3f98d65c.js',function(){input.required=false;search();});}
