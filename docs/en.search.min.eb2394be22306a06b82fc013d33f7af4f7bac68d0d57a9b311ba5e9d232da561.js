...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/lds-ctrl-est/flexsearch.min.js');loadScript('/lds-ctrl-est/en.search-data.min.8cfc6e568779f958e8f86936c28f0c7db880c09aff3d16dcb90cdc257b146a5d.js',function(){input.required=false;search();});}
