...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/lds-ctrl-est/flexsearch.min.js');loadScript('/lds-ctrl-est/en.search-data.min.43a968c4da3fac8c6add2e0e121fa8d652bd68451645d4eef7608f253571f6a1.js',function(){input.required=false;search();});}
