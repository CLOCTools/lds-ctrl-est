...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/ldsctrlest/flexsearch.min.js');loadScript('/ldsctrlest/en.search-data.min.6afcec532389ab0cda5b737c0027ba02e18a252baddbc3df710178f620196b2e.js',function(){input.required=false;search();});}
