...
dt = h5read('test_plds_ctrl.h5','/dt');
u = h5read('test_plds_ctrl.h5','/u');
z = h5read('test_plds_ctrl.h5','/z');

lambdaRef = h5read('test_plds_ctrl.h5','/lambdaRef');
lambdaTrue = h5read('test_plds_ctrl.h5','/lambdaTrue');
lambdaHat= h5read('test_plds_ctrl.h5','/lambdaHat');

xTrue = h5read('test_plds_ctrl.h5','/xTrue');
xHat= h5read('test_plds_ctrl.h5','/xHat');

mTrue = h5read('test_plds_ctrl.h5','/mTrue');
mHat= h5read('test_plds_ctrl.h5','/mHat');
