...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[set_y_ref](/ldsctrlest/docs/api/classes/classlds_1_1gaussian_1_1_switched_controller/#function-set_y_ref)**(const Vector & y_ref) override<br>sets reference output  |
