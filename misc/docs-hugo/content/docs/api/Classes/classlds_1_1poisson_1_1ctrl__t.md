...
Inherits from [lds::poisson::sys_t](/ldsctrlest/docs/api/classes/classlds_1_1poisson_1_1sys__t/), [lds::sys_t](/ldsctrlest/docs/api/classes/classlds_1_1sys__t/)

Inherited by [lds::poisson::sctrl_t](/ldsctrlest/docs/api/classes/classlds_1_1poisson_1_1sctrl__t/)
...
| void | **[setU](/ldsctrlest/docs/api/classes/classlds_1_1poisson_1_1ctrl__t/#function-setu)**(stdVec & uVec)<br>Set input (u)  |
| void | **[setU](/ldsctrlest/docs/api/classes/classlds_1_1poisson_1_1ctrl__t/#function-setu)**(armaVec & u)<br>Set input (u)  |
...
| void | **[setKc_x](/ldsctrlest/docs/api/classes/classlds_1_1poisson_1_1ctrl__t/#function-setkc_x)**(stdVec & Kc_xVec)<br>Set state controller gain (Kc_x)  |
| void | **[setKc_x](/ldsctrlest/docs/api/classes/classlds_1_1poisson_1_1ctrl__t/#function-setkc_x)**(armaMat & Kc_x)<br>Set state controller gain (Kc_x)  |
| void | **[setKc_u](/ldsctrlest/docs/api/classes/classlds_1_1poisson_1_1ctrl__t/#function-setkc_u)**(stdVec & Kc_uVec)<br>Set input controller gain (Kc_u)  |
| void | **[setKc_u](/ldsctrlest/docs/api/classes/classlds_1_1poisson_1_1ctrl__t/#function-setkc_u)**(armaMat & Kc_u)<br>Set input controller gain (Kc_u)  |
| void | **[setKc_inty](/ldsctrlest/docs/api/classes/classlds_1_1poisson_1_1ctrl__t/#function-setkc_inty)**(stdVec & Kc_intyVec)<br>Set integral controller gain (Kc_inty)  |
| void | **[setKc_inty](/ldsctrlest/docs/api/classes/classlds_1_1poisson_1_1ctrl__t/#function-setkc_inty)**(armaMat & Kc_inty)<br>Set integral controller gain (Kc_inty)  |
| void | **[setControlType](/ldsctrlest/docs/api/classes/classlds_1_1poisson_1_1ctrl__t/#function-setcontroltype)**(size_t controlType)<br>Set controller type.  |
