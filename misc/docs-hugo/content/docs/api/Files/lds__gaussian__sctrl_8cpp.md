---
title: src/lds_gaussian_sctrl.cpp
summary: GLDS switched controller type. 

---

# src/lds_gaussian_sctrl.cpp
...
This file implements the type for switched feedback control of a system approximated as multiple discrete Gaussian-output linear dynamical systems (`[lds::gaussian::sctrl_t](/ldsctrlest/docs/api/classes/classlds_1_1gaussian_1_1sctrl__t/)`). 
