---
title: src/lds_gaussian_ctrl.cpp
summary: GLDS controller type. 

---

# src/lds_gaussian_ctrl.cpp
...
This file implements the type for feedback control of a gaussian-output linear dynamical system (`[lds::gaussian::ctrl_t](/ldsctrlest/docs/api/classes/classlds_1_1gaussian_1_1ctrl__t/)`). It inherits functionality from the underlying GLDS model type (`[lds::gaussian::sys_t](/ldsctrlest/docs/api/classes/classlds_1_1gaussian_1_1sys__t/)`), including state estimation. 
