---
title: src/lds_poisson_sctrl.cpp
summary: PLDS switched controller type. 

---

# src/lds_poisson_sctrl.cpp
...
This file implements the type for switched feedback control of a system approximated as multiple discrete Poisson-output linear dynamical systems (`[lds::poisson::sctrl_t](/ldsctrlest/docs/api/classes/classlds_1_1poisson_1_1sctrl__t/)`). 
