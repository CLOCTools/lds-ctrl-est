...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/ldsctrlest/flexsearch.min.js');loadScript('/ldsctrlest/en.search-data.min.9bd4242d6af181cddeced33cda7890aea67522c2873b0f666399e0d68c4416be.js',function(){input.required=false;search();});}
